...
(defvar-local eglot--last-reported-diagnostics nil
  "Last reported Flymake diagnostics for this buffer.")
...
`flymake-backend-functions')."
  (cond (eglot--managed-mode
         ...
         (eglot--report-to-flymake
          ;; Immediately report either unreported stuff or last
          ;; reported stuff.
          (or eglot--unreported-diagnostics
              eglot--last-reported-diagnostics)))
        (t
...
(defun eglot--report-to-flymake (diags)
  ...
  (setq eglot--unreported-diagnostics nil
        eglot--last-reported-diagnostics diags))
